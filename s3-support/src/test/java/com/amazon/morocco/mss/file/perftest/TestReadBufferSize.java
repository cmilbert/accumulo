...
public class TestReadBufferSize {
    ...
    private static FSDataInputStream getTestFileInputStream(int bufferSize, Path testFilePath) throws IOException {
    ...
    public static double test(int bufferSize, Path testFilePath) throws Exception {
        ...
        //System.out.println("Buffer: "+bufferSize+" Read "+totalRead+" bytes in "+(endTime - startTime)+"ms");
