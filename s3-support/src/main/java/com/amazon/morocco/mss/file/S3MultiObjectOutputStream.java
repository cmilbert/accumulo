...
public class S3MultiObjectOutputStream extends OutputStream implements Syncable {
    ...
    public S3MultiObjectOutputStream(S3ClientWrapper s3, String bucketName, String objectName) throws IOException {
        this.s3 = s3;
    ...
    private static void upload(S3ClientWrapper s3, String bucketName, String objectPrefix, byte[] contents, int partNumber) throws IOException {
