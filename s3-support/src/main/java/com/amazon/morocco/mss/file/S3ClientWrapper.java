...
/**
 * Wrap calls to S3 and apply generic exception handling, including retires on service exceptions, handling of eventual consistency, and promotion of
 * RuntimeExceptions to IOExceptions
 *
 * @author afuchs
 */
public class S3ClientWrapper {
    ...
    public void abortMultipartUpload(AbortMultipartUploadRequest abortMultipartUploadRequest) throws IOException {
        try {
    ...
    public void completeMultipartUpload(CompleteMultipartUploadRequest completeRequest) throws IOException {
        try {
    ...
    public MultipartUploadListing listMultipartUploads(ListMultipartUploadsRequest req) throws IOException {
        try {
    ...
    public InitiateMultipartUploadResult initiateMultipartUpload(InitiateMultipartUploadRequest request) throws IOException {
        try {
    ...
    public S3ResponseMetadata getCachedResponseMetadata(AmazonWebServiceRequest request) throws IOException {
        try {
